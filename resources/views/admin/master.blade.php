    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin Area - Kỳ Thịnh</a>
            </div>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('getListBanner') }}">List Banner</a>
                                </li>
                                <li>
                                    <a href="{{ route('getBannerAdd') }}">Add Banner</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> Content<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('getListContent') }}">List Content</a>
                                </li>
                                <li>
                                    <a href="{{ route('getContentAdd') }}">Add Content</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
